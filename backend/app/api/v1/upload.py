...
def upload_document_file(
    *,
    ...
    if ext not in allowed_extensions:
        raise HTTPException(status_code=400, detail="File provided is not a supported document format.")
...
def upload_chat_file(
    *,
    ...
    if ext not in allowed_extensions:
        raise HTTPException(status_code=400, detail=f"Extension .{ext} non supportée. Formats autorisés : PDF, Office, TXT, Audio, Vidéo, Images.")
