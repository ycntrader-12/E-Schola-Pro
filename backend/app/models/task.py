...
class Task(Base):
    ...
    target_role = Column(String, default="all", nullable=False) # 'all', 'étudiant', 'stagiaire', 'employer'
    ...
    priority = Column(String, default="moyenne", nullable=False) # 'haute', 'moyenne', 'basse'
